// original file, modified for use
// https://github.com/gkjohnson/urdf-loaders/blob/6d64c33f0221c428cf76f2f00c4bd14ffd9ae400/javascript/src/urdf-viewer-element.js
...
export default class URDFViewer extends HTMLElement {
  ...
  constructor() {
    ...
    window.cam = camera.position;
    console.log(JSON.stringify(camera.position), camera.position);
